...
inline tulpaOcc::OccResponseData build_occ_response(
...
inline void add_visit_covariates(
    tulpaOcc::OccResponseData& occ, Rcpp::NumericMatrix Xv
) {
...
// ============================================================================
inline tulpaOcc::DynOccResponseData build_dyn_occ_response(
