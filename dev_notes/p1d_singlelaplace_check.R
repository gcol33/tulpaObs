# Confirm my Phase 1d edits to family_cover_hurdle.R didn't break the
# single-Laplace path for either positive variant.
suppressMessages({
...
library(testthat)
files <- c(
  "C:/Users/Gilles Colling/Documents/dev/tulpaObs/tests/testthat/test-cover-hurdle-lognormal.R",
  "C:/Users/Gilles Colling/Documents/dev/tulpaObs/tests/testthat/test-cover-hurdle-beta.R"
)
total_pass <- 0L
total_fail <- 0L
for (f in files) {
