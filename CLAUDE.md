...
- **Continuous NNGP `svc()` term** (`spatial(lon, lat, model="svc",
  ...
  **RECOVERY-VALIDATED** (#119, tulpa 0.0.82, `test-occu-svc-nngp-recovery.R`):
  divergences fell to 0 every seed, phi recovered onto truth. Two upstream causes:
